...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Elena Marchetti — Photography" },
      { name: "description", content: "Editorial, retrato e paisagem. Portfólio selecionado de Elena Marchetti." },
      { property: "og:title", content: "Elena Marchetti — Photography" },
      { property: "og:description", content: "Portfólio editorial e contemporâneo de fotografia." },
